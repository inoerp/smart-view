...
<html>
 <head>
  ...
  if (!empty($metaname_description)) {
   echo "<meta name='description' content=\"SmartView - A Open Source PHP based Enterprise Management System\">";
  }
  ?>
  <meta name="keywords" content="ERP,PHP ERP,Open Source ERP ">
  <title><?php echo isset($pageTitle) ? $pageTitle . ' - SmartView!' : ' SmartView! ' ?></title>
    ...
    <div class="container">
     <nav class="navbar yamm navbar-default ">
      <div class="navbar-header">
       ...
       <a href="<?php echo HOME_URL; ?>" class="navbar-brand"><?php echo!empty($si->site_name) ? $si->site_name : 'SmartView'; ?></a>
      </div>
...
<!--      <a class="list-header" href="http://localhost/inoerp/form.php?class_name=po_requisition_header&amp;mode=9">&nbsp;<i class="fa fa-dot-circle-o"></i> &nbsp; Requisition</a>
      ...
      <div class="row">
       <?php
       $report_k = new extn_report();
       $report_k->extn_report_id = 3;
       echo $report_k->extn_reportResultById();
       ?>
      </div>
