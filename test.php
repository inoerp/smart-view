...
//pa(get_dbColumns('inv_location_default'));
//pa(get_dbColumns('prj_resource_list_line'));
//pa(get_dbColumns('prj_category_line'));
...
//pa($_SESSION);
//$email = 'Nishit.Das@coherent.com,anana@sdas.com';
